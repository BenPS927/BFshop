...
export default function MerchantPage() {
  ...
  return (
    ...
    >
      <section className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-[1600px] grid-rows-[auto_1fr] gap-6 pt-6 md:min-h-[calc(100vh-4rem)] md:gap-8 md:pt-0 lg:min-h-[calc(100vh-6rem)] lg:gap-12">
        <header className="grid grid-cols-[1fr_auto_1fr] items-start gap-4 pb-3 md:pb-0">
          <div className="pt-2">
            <Link
              href="/"
        ...
        <div className="mt-2 md:mt-0">
          ...
          <div className="-mr-4 flex snap-x snap-mandatory gap-4 overflow-x-auto pb-5 md:-mr-6 md:gap-6 md:pb-2 lg:mr-0 lg:grid lg:grid-cols-3 lg:gap-8 lg:overflow-visible lg:pb-0">
            {boards.map((board) => (
